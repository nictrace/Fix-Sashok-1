...
public final class y {
   ...
   static String getFirstLineOfCommand(String ... commands) throws IOException {
      ...
      try {
         ...
         if(p != null) {
        	 // следующа€ команда приведет к завершению программы 
   ...
   /**
    * Ќе реализованна€ пока процедура, смысл в том, что внешн€€ программа, которую мы запустили,
    * передала не все данные и пока не завершилась. Ќадо забрать данные и подождать, а если
